...
<div class="post">
	...
	<a href="<?php echo esc_url( $thumbnail['fullpath'] ); ?>" class="lightbox fancybox" rel="media" title="<?php the_title();?>"><img src="<?php echo esc_url($thumbnail['fullpath']); ?>" class="gallery_full" /></a>
