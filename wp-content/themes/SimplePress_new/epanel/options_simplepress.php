	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Blue", "Green", "Purple", "Red",)),		   
			...
			array( "name" => "Number of Posts displayed on Gallery page",
                   "id" => $shortname."_gallery_posts",
                   "std" => "12",
                   "type" => "text",
				   "desc" => "Here you can designate how many recent articles are displayed on the Gallery page. This option works independently from the Settings > Reading options in wp-admin."),
			...
			array( "name" => "Choose a Gallery Category",
				   "id" => $shortname."_gallery",
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose the category you would like to populate your gallery with. ",
				   "options" => $site_cats),
			...
			array( "name" => "Enable/Disable Gallery Functionality",
                   "id" => $shortname."_gallery_enable",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Disable this option if you don't want to have a gallery section on your website."),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Service page 1",
				   "id" => $shortname."_service_1",
				   "std" => "",
				   "type" => "select",
				   "desc" => "Choose the page you would like to display in the Service Page area. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
			
			array( "name" => "Service page 2",
				   "id" => $shortname."_service_2",
				   "std" => "",
				   "type" => "select",
				   "desc" => "Choose the page you would like to display in the Service Page area. ",
				   "options" => $site_pages,
			...
			array( "name" => "Service page 3",
				   "id" => $shortname."_service_3",
				   "std" => "",
				   "type" => "select",
				   "desc" => "Choose the page you would like to display in the Service Page area. ",
				   "options" => $site_pages,
			...
			array( "name" => "Display Homepage Quote",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "This controls the two-lined quote that apperas on the homepage below the featured slider."),
			
			array( "type" => "clearfix",),
			
			array( "name" => "Quote Line 1",
                   "id" => $shortname."_quote_one",
                   "std" => "PROVIDING THE BEST DESIGN SERVICES ON THE INTERNET",
                   "type" => "text",
				   "desc" => "Here you can define the text that appears in the homepage quote."),
			
			array( "name" => "Quote Line 2",
                   "id" => $shortname."_quote_two",
                   "std" => "we create amazingly beautiful designs at a price that is absolutely unbelieveable",
                   "type" => "text",
				   "desc" => "Here you can define the text that appears in the homepage quote."),
			
			array( "name" => "Grey Strip Text",
                   "id" => $shortname."_strip",
                   "std" => "Its time that you took your website to the next level. ",
                   "type" => "textarea",
				   "desc" => "Here you can define the text that appears in the gray strip on the homepage."),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-colorization",
		...
		array( "name" => "colorization-1",
			...
			array( "name" => "Main link hover color (in the post body)",
				   "id" => $shortname."_color_mainlink_hover",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
			...
			array( "name" => "Sidebar text color",
				   "id" => $shortname."_color_sidebar_text",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
			...
			array( "name" => "Postinfo text color",
				   "id" => $shortname."_color_postinfo",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
			
			array( "name" => "Postinfo links color",
				   "id" => $shortname."_color_postinfo_links",
				   "type" => "textcolorpopup",
				   "std" => "",
				   "desc" => "This option allows you to customize the color of a certain element of the theme. When you click inside the field a color picker will appear. Scroll to find your desired color and then click the circular submit button on the lower right to accept the value",),
...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		.post a:link, .post a:visited, #posts a, #posts a:visited { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		.post a:hover, #posts a:hover { color: #<?php echo(get_option($shortname.'_color_mainlink_hover')); ?>; }
		...
		#sidebar .widget ul li a  { color:#<?php echo(get_option($shortname.'_color_sidebar_links')); ?>; }
		#sidebar .widget ul li, #sidebar .widget  { color:#<?php echo(get_option($shortname.'_color_sidebar_text')); ?>; }
		#footer { color:#<?php echo(get_option($shortname.'_color_footer')); ?> !important; }
		#footer a { color:#<?php echo(get_option($shortname.'_color_footer_links')); ?> !important; }
		.post .postinfo { color: #<?php echo(get_option($shortname.'_color_postinfo')); ?> !important;}
		.postinfo a { color: #<?php echo(get_option($shortname.'_color_postinfo_links')); ?> !important; }
	</style>
